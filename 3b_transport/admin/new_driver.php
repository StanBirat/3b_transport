    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card shadow">
          <div class="card-body">
            <h4 class="card-title text-center">Driver Registration</h4>
            ...
            <p class="text-center mt-3"><a href="admin_index.php">Manage Driver</a></p>
            ...
            <?php
              if (isset($_POST['register'])) {
                ...
                $stmt = $conn->prepare("INSERT INTO drivers (name, phone, email, vehicle_no, license_image, vehicle_image, password, status) VALUES (?, ?, ?, ?, ?, ?, ?, 'approved')");
                $stmt->bind_param("sssssss", $name, $phone, $email, $vehicle_no, $license_path, $vehicle_path, $password);

                if ($stmt->execute()) {
                  echo "<div class='alert alert-success mt-2'>Registration successful. Your account has been activated.</div>";
                } else {
